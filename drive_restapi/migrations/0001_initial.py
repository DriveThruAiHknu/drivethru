# Generated by Django 3.1.3 on 2022-03-21 14:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='todayUsers',
            fields=[
                ('todayUserID', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderTodayID', models.IntegerField()),
                ('memberID', models.ForeignKey(db_column='memberID', on_delete=django.db.models.deletion.CASCADE, to='drive_restapi.members')),
                ('todayUserID', models.ForeignKey(db_column='todayUserID', on_delete=django.db.models.deletion.CASCADE, to='drive_restapi.todayusers')),
            ],
        ),
        migrations.CreateModel(
            name='items',
            fields=[
                ...
                ('orderID', models.ForeignKey(db_column='orderID', on_delete=django.db.models.deletion.CASCADE, to='drive_restapi.orders')),
                ('prodID', models.ForeignKey(db_column='prodID', on_delete=django.db.models.deletion.CASCADE, to='drive_restapi.prods')),
            ],
        ),
    ]
